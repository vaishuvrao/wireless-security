...
set tracefile [open out_900.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open out_900.nam w]
...
$val(mac) set CWMin_ 1
$val(mac) set CWMax_ 32
